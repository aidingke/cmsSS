...
<div class="row">
<div class="quick-btn">
<a href="<?php echo $base_url;?>/index.php?case=table&act=list&table=archive&admin_dir=<?php echo get('admin_dir');?>&site=default" class="q8">内容管理</a>
</div>
</div>
</div>
...
&nbsp;<a href="<?php echo $base_url;?>/index.php?case=update&act=index&admin_dir=<?php echo get('admin_dir');?>&site=default" class="btn btn-steeblue btn-xs">检查更新</a></td>
</tr>
</table>
