...
var iframename = "";
var checkfrom="<?php echo front::get('checkfrom');?>";
var getbyid="<?php echo front::get('getbyid');?>";
var editiframename="";
var fileinputid="<?php echo front::get('fileinputid');?>";
var digheight="420";
var rootDIR="";
var picview="index.php?case=file&act=ps&max=<?php echo front::get('max');?>";
...
<?php if(is_array($roles) && !empty($roles)) { ?><li id="tabbottonul3" href="#body" onmousedown="javascript:windowsclass('#tabbottonul3','#tabcontentdiv3','tabbottonul','tabcontentdiv',3,4,'hover','hover2');flushiframe('piclist');">图库浏览模式</li><?php } ?>
</ul>
</div>
