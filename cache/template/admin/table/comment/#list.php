...
<td class="catname" align="left" style="padding-left:10px;"><?php echo cut($d['content']);?></td>
<td class="htmldir" align="left"><?php echo cut($d['username']);?></td>
<td class="htmldir" align="center"><?php if($d['state']) { ?><font color="#006600">已审</font><?php } else { ?><font color="#990000">未审</font><?php } ?></td>
