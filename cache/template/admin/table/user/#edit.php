...
<?php echo form::getform('username',$form,$field,$data);?>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::getform('passwordnew',$form,$field,$data);?>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::getform('nickname',$form,$field,$data);?> 
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::getform('question',$form,$field,$data);?>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::getform('answer',$form,$field,$data);?>
</div>
</div>  
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::getform('qq',$form,$field,$data);?>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::getform('e_mail',$form,$field,$data);?>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::getform('tel',$form,$field,$data);?>
</div>
</div>
</div>
