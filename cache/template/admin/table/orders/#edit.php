...
<font color="red"><?php echo $data['oid'];?></font>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo date('Y-m-d H:i:s',$data['adddate']);?>
</div>
</div>
<div class="clearfix blank20"></div>
...
<table width="70%" border="0">
  ...
  <?php if(is_array($_archivearr))
foreach($_archivearr as $key => $_archive) { ?>
...
$total = $_archive['attr2'] * $orders['pnums'] + $logistics['0']['price'] + ($_archive['attr2'] * $orders['pnums'] * $pay['0']['pay_fee']);	
  ...
  <tr>
    <td><a href="<?php echo url('archive/show/aid/'.$_archive['aid'], false);?>" target="_blank"><?php echo $_archive['title'];?></a></td>
    <td><?php echo $_archive['attr2'];?></td>
    <td><strong>小计</strong>：[产品单价] * [订购数量] +  [配送费用] + [支付手续费] = [总额]
        <br />
        <?php echo $_archive['attr2'];?> * <?php echo $orders['pnums'];?> + <?php echo $logistics['0']['price'];?> + (<?php echo $_archive['attr2'];?> * <?php echo $orders['pnums'];?> * <?php echo $pay['0']['pay_fee'];?>) = <?php echo $total;?></td>
  </tr>
  <?php } ?>
  <tr>
    <td colspan="3"><strong>总计：<?php echo $listtotal;?></strong></td>
  </tr>
  ...
  ?>  
       <div>
        <a href="<?php echo url('archive/show/aid/'.$_archive['aid'], false);?>" target="_blank"><?php echo $data['aid'];?> ￥<?php echo $_archive['attr2'];?></a>&nbsp;&nbsp;(订购量：<?php echo $data['pnums'];?>)&nbsp;&nbsp; <br />
        <strong>合计</strong>：[产品单价] * [订购数量] +  [配送费用] + [支付手续费] = [总额]
        <br />
        <?php echo $_archive['attr2'];?> * <?php echo $orders['pnums'];?> + <?php echo $logistics['0']['price'];?> + (<?php echo $_archive['attr2'];?> * <?php echo $orders['pnums'];?> * <?php echo $pay['0']['pay_fee'];?>) = <?php echo $total;?>
        </div> 
      <?php
  }
  ?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo $data['pname'];?>（<?php echo $data['mid'];?>）
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<font color="red"><?php echo $data['status'];?></font>
        <br />
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<label>
<input type="text" name="courier_number" id="courier_number" value="<?php echo $data['courier_number'];?>" class="form-control" />
</label>
