...
<td class="catname" align="center"><?php echo $d['oid'];?></td>
<td class="catname" align="left"><?php echo $d['pname'];?></td>
<td class="htmldir" align="center"><?php echo $d['status'];?></td>
<td class="htmldir" align="center"><?php echo date('Y-m-d H:i:s',$d['adddate']);?></td>
