...
<table width="100%" align="center" class="usergroup-table table">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                    ...
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                          ...
                          <td class="unit"><input class="content content_archive" type="checkbox" name="powerlist[archive_tag]" <?php echo getchecked($data['powerlist'],'archive_tag');?> value="1" />
                            标签管理</td>
                            <td class="unit"><input class="content content_archive" type="checkbox" name="powerlist[archive_import]" <?php echo getchecked($data['powerlist'],'archive_import');?> value="1" />
                            批量导入</td>
                        </tr>
                      </table></td>
                  </tr>
                  ...
                  <tr>
                    <td colspan="1" width="120" class="col" valign="center"><input class="func" type="checkbox" name="powerlist[func_filecheck]" <?php echo getchecked($data['powerlist'],'func_filecheck');?> value="1" id="func_filecheck">
                    安全防护</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                          <td class="unit"><input class="func func_filecheck" type="checkbox" name="powerlist[func_filecheck]" <?php echo getchecked($data['powerlist'],'func_filecheck');?> value="1" />
                            文件校对</td>
                          <td class="unit"><input class="func func_filecheck" type="checkbox" name="powerlist[func_scan]" <?php echo getchecked($data['powerlist'],'func_scan');?> value="1" />
                            木马查杀</td>
                        </tr>
                      </table></td>
                  </tr>
