...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('parentid',$form,$field,$data);?><span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="如果为一级栏目，不需选择！"></span>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('catname',$form,$field,$data,'class="form-control"');?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('subtitle',$form,$field,$data,'class="form-control"');?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><input type="text" name="htmldir" id="htmldir" value="<?php echo $data['htmldir'];?>" class="form-control" onkeyup="value=value.replace(/[^0-9a-zA-Z-]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" /> <span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="目录必须是英文名，留空则自动使用拼音名，请勿夹杂符号！"></span>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('isnav',$form,$field,$data);?>  <span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="如果是一级目录，可选择是否在导航中显示栏目名称和链接！"></span>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('ismobilenav',$form,$field,$data);?>  <span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="如果是一级目录，可选择是否在导航中显示栏目名称和链接！"></span>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('meta_title',$form,$field,$data,'class="form-control"');?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('keyword',$form,$field,$data,'class="form-control"');?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('description',$form,$field,$data,'');?>
...
<span id="helpBlock2" class="help-block">如有分页，请一定要在自定义名称后加入分页函数_<b>{</b>$page<b>}</b>！</span>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left form-group has-success"><input name="listhtmlrule1" type="text" class="form-control" value="<?php echo $data['listhtmlrule'];?>" />
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="<strong>默&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;认：</strong>&#123;$caturl&#125;/&#123;$page&#125;.html <br /><strong>短&nbsp;&nbsp;目&nbsp;&nbsp;录：</strong>&#123;$dir&#125/&#123;$page&#125;.html<br /><strong>自&nbsp;&nbsp;定&nbsp;&nbsp;义：</strong>自定义（英文或拼音）/&#123;$page&#125;.html<br /><strong>栏目目录：</strong>&#123;$caturl&#125;<br /><strong>当前目录：</strong>&#123;$dir&#125;<br /><strong>注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意：</strong>&#123;$page&#125;必须存在URL内且为最后！"></span>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left form-group has-warning"><input name="showhtmlrule1" type="text" class="form-control" value="<?php echo $data['showhtmlrule'];?>" />
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('template',$form,$field,$data);?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('listtemplate',$form,$field,$data);?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('showtemplate',$form,$field,$data);?>
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="栏目下属内容页模板样式！');" onmouseout="tooltip.hide();">
</span>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('templatewap',$form,$field,$data);?>
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="当前栏目应用的模板样式！');" onmouseout="tooltip.hide();">
</span>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('listtemplatewap',$form,$field,$data);?>
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="栏目下属子级栏目应用模板样式！');" onmouseout="tooltip.hide();">
</span>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('showtemplatewap',$form,$field,$data);?>
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="栏目下属内容页模板样式！');" onmouseout="tooltip.hide();">
</span>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('showform',$form,$field,$data);?>
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="栏目下属内容页绑定表单！');" onmouseout="tooltip.hide();">
</span>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('isshow',$form,$field,$data);?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('ishtml',$form,$field,$data);?>
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="选择栏目显示状态！');" onmouseout="tooltip.hide();">
</span>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('ispages',$form,$field,$data);?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('attr3',$form,$field,$data,'class="input_c"');?>
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="留空按全局设置数量显示！');" onmouseout="tooltip.hide();">
</span>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('ecoding',$form,$field,$data,'class="form-control"');?>
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="防伪码前缀！');" onmouseout="tooltip.hide();">
</span>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('includecatarchives',$form,$field,$data);?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('linkto',$form,$field,$data,'class="form-control"');?>
...
<div class="col-xs-8 col-sm-8 col-md-7 col-lg-5 text-left"><?php echo form::getform('categorycontent',$form,$field,$data);?> 
<img src="<?php echo $skin_path;?>/images/remind.gif"  data-toggle="tooltip" data-html="ture" data-placement="left" title="如使用设置栏目封面，请在模板处选择本栏目应用list_page.html模板！');" onmouseout="tooltip.hide();">
</div>
</div>
<div class="clearfix blank20"></div>
<style type="text/css">
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('image',$form,$field,$data);?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::input('thumb_width',$data['thumb_width']);?>
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="仅限于模板中使用该参数时有效！<br >默认: <?php echo type::getwidthofthumb(get('id'));?> px × <?php echo type::getheightofthumb(get('id'));?> px！" onmouseout="tooltip.hide();"></span>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::input('thumb_height',$data['thumb_height']);?>
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="仅限于模板中使用该参数时有效！<br >默认: <?php echo type::getwidthofthumb(get('id'));?> px × <?php echo type::getheightofthumb(get('id'));?> px！" onmouseout="tooltip.hide();"></span>
</div>
</div>
<div class="clearfix blank20"></div>
