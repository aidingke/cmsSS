...
<input class="btn btn-primary" type="button" value=" 添加分类 " onclick="javascript:window.location.href='index.php?case=table&act=add&table=type&admin_dir=<?php echo get('admin_dir');?>'" />
...
?>
<tr>
<td align="center" class="s_out"><input onclick="c_chang(this)" type="checkbox" value="<?php echo $d[$primary_key];?>" name="select[]"> </td>
<td class="sort"><?php echo form::input("listorder[$d[$primary_key]]",$d['listorder'],'size=3');?></td>
<td align="center" class="catid"><?php echo $d['typeid'];?> </td>
<td align="left" style="padding-left:10px;" class="catname"><?php echo $d['typename'];?> </td>
<td align="center" class="manage">

<a href="<?php echo url("type/list/typeid/$d[$primary_key]",false);?>" target="_blank">查看</a>

<a href="<?php echo modify("/act/edit/table/$table/id/$d[$primary_key]");?>" target="_blank">编辑</a>
...
<tr>
<td align="center" class="s_out"><input onclick="c_chang(this)" type="checkbox" value="<?php echo $d1[$primary_key];?>" name="select[]"> </td>
<td class="sort"><?php echo form::input("listorder[$d1[$primary_key]]",$d1['listorder'],'size=3');?></td>
<td align="center"><?php echo $d1['typeid'];?></td>
<td align="left" style="padding-left:10px;"><?php echo $d1['typename'];?></td>
  
<td align="center" class="manage">

<a href="<?php echo url("type/list/typeid/$d1[$primary_key]",false);?>" target="_blank">查看</a>

<a href="<?php echo modify("/act/edit/table/$table/id/$d1[$primary_key]");?>" target="_blank">编辑</a>
