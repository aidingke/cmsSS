...
<a href="<?php echo $base_url;?>/index.php?case=table&act=add&table=announcement&admin_dir=<?php echo get('admin_dir');?>&site=default" class="btn btn-primary">添加公告</a>
...
<td align="left" class="catid"><?php echo cut($d['content']);?></td>
<td class="catid" align="center" ><?php echo cut($d['adddate']);?></td>
