...
<style type="text/css">
body {
  background:#6f8489 url(<?php echo $skin_path;?>/images/login-bg.jpg) left top no-repeat;background-attachment: fixed; background-size: cover;
  min-height: 100%;
}
...
<script type="text/javascript" src="<?php echo $skin_path;?>/js/jquery-1.11.2.min.js"></script>
 ...
 <div class="logo"><img src="<?php echo $skin_path;?>/images/logo-login.png"></div>
...
<input placeholder="<?php echo lang('tel');?>" type='text' id="tel"  name="tel" value="" tabindex="3" class="form-control" />
<input id="btm_sendMobileCode" onclick="sendMobileCode('<?php echo url('tool/smscode',false);?>',$('#tel'));" type="button" value="<?php echo lang('send_cell_phone_verification_code');?>" />
...
<input type='text' id="verify"  tabindex="3" onKeyUp="value=value.replace(/[\W]/g,'')" name="verify" /><?php echo verify();?>
<?php } ?>
