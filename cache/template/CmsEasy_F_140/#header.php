...
<!-- logo -->
<a href="<?php echo $base_url;?>/" class="navbar-brand text-center"><img src="<?php echo get('site_logo');?>" class="img-responsive" alt="<?php echo get(sitename);?>" width="<?php echo get(logo_width);?>" /></a>
<!-- logo end -->
</div>
