...
<th><?php echo lang('nowdownload');?>：</th>
 <td><?php if($archive['attachment_path']) { ?>
...
<div class="item img-auto<?php if($i==1) { ?> active<?php } ?>">
<a rel="lightbox['roadtrip']"><img src="<?php echo $pic['url'];?>" alt="<?php echo $pic['alt'];?>" class="img-responsive" onerror='this.src="<?php echo config::get('onerror_pic');?>"' /></a>
</div>
<?php } ?>
</div>
<!-- 左右按钮 -->
