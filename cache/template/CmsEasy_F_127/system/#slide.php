 ...
 <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p class="wow bounceIn" data-wow-delay="0.5s"><a class="btn btn-lg btn-primary" href="<?php echo get(slide_pic1_url);?>" role="button"><?php echo lang(more);?></a></p>
            </div>
          </div>
        </div>
 <?php } elseif (get('slide_number')=='2') { ?>
        ...
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p class="wow bounceIn" data-wow-delay="0.5s"><a class="btn btn-lg btn-primary" href="<?php echo get(slide_pic2_url);?>" role="button"><?php echo lang(more);?></a></p>
            </div>
          </div>
        </div>
 <?php } elseif (get('slide_number')=='3') { ?>
         ...
         <img class="first-slide" src="<?php echo get(slide_pic3);?>" alt="<?php echo get(slide_pic3_title);?>">
          <div class="container">
            <div class="carousel-caption">
              ...
              <p class="wow bounceIn" data-wow-delay="0.5s"><a class="btn btn-lg btn-primary" href="<?php echo get(slide_pic3_url);?>" role="button"><?php echo lang(more);?></a></p>
            </div>
          </div>
        </div>
 <?php } elseif (get('slide_number')=='4') { ?>
        ...
        <img class="first-slide" src="<?php echo get(slide_pic4);?>" alt="<?php echo get(slide_pic4_title);?>">
          <div class="container">
            <div class="carousel-caption">
              ...
              <p class="wow bounceIn" data-wow-delay="0.5s"><a class="btn btn-lg btn-primary" href="<?php echo get(slide_pic4_url);?>" role="button"><?php echo lang(more);?></a></p>
            </div>
          </div>
        </div>
<?php } else { ?>
         ...
         <img class="first-slide" src="<?php echo get(slide_pic5);?>" alt="<?php echo get(slide_pic5_title);?>">
          <div class="container">
            <div class="carousel-caption">
              ...
              <p class="wow bounceIn" data-wow-delay="0.5s"><a class="btn btn-lg btn-primary" href="<?php echo get(slide_pic5_url);?>" role="button"><?php echo lang(more);?></a></p>
            </div>
          </div>
        </div>
 <?php } ?>
