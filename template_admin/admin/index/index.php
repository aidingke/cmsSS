...
<div class="alert alert-warning alert-dismissible" role="alert">
  ...
  <span class="glyphicon glyphicon-warning-sign"></span>	 欢迎使用	<strong>CmsEasy</strong> 易通企业网站系统，通过后台系统您可以轻松管理网站内容。在感谢您使用的同时，我们为您准备了超过一百套的免费网站模板供用户选择使用，点击左侧导航中的	[	模板	]	&rarr;	[	<a href="{$base_url}/index.php?case=template&act=downlist&admin_dir={get('admin_dir')}&site=default">更多模板</a>	]	进行选择！</a>
</div>
