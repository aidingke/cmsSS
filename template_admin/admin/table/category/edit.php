...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('parentid',$form,$field,$data)}<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="如果为一级栏目，不需选择！"></span>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('isnav',$form,$field,$data)}  <span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="如果是一级目录，可选择是否在导航中显示栏目名称和链接！"></span>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('ismobilenav',$form,$field,$data)}  <span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="如果是一级目录，可选择是否在导航中显示栏目名称和链接！"></span>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('template',$form,$field,$data)}
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('listtemplate',$form,$field,$data)}
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('showtemplate',$form,$field,$data)}
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('templatewap',$form,$field,$data)}
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="当前栏目应用的模板样式！');" onmouseout="tooltip.hide();">
</span>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('listtemplatewap',$form,$field,$data)}
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="栏目下属子级栏目应用模板样式！');" onmouseout="tooltip.hide();">
</span>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('showtemplatewap',$form,$field,$data)}
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="栏目下属内容页模板样式！');" onmouseout="tooltip.hide();">
</span>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('showform',$form,$field,$data)}
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('isshow',$form,$field,$data)}
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('ishtml',$form,$field,$data)}
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('ispages',$form,$field,$data)}
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('attr3',$form,$field,$data,'class="input_c"')}
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('ecoding',$form,$field,$data,'class="form-control"')}
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('includecatarchives',$form,$field,$data)}
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('linkto',$form,$field,$data,'class="form-control"')}
...
<div class="col-xs-8 col-sm-8 col-md-7 col-lg-5 text-left">{form::getform('categorycontent',$form,$field,$data)} 
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">{form::getform('image',$form,$field,$data)}
